export default {
  ...
  settings: {
    ...
    model: {
      ...
      claudeCodeOauthRevokeHint: 'Sign out from the Claude Code app to revoke. HHAIOS does not modify Claude Code\'s on-disk credentials.',
  ...
  agents: {
    ...
    templates: {
      ...
      runtimeTitle: 'Choose Runtime',
      runtimeDesc: 'Local employees use HHAIOS skills and knowledge bases. External agents run configured Hermes / Codex / OpenClaw directly.',
      templateDivider: 'Or start from a role template',
      skip: 'Start from Scratch',
      applied: 'Employee onboarded',
    },
    runtime: {
      localTitle: 'HHAIOS Local Employee',
      localDesc: 'Uses models, skills, tools, and knowledge bases for regular business roles.',
      localBadge: 'Local',
      externalDesc: 'Promote {name} to an employee runtime; chat calls the external agent directly.',
      externalBadge: 'External Agent',
      externalDefaultDescription: 'External ACP employee powered by {name}',
    },
    teams: {
      kicker: 'Team Orchestration',
      title: 'Teams',
      desc: 'Group employees into one collaboration unit. A native HHAIOS coordinator decomposes, delegates, and summarizes work.',
      create: 'Create Team',
      newTitle: 'Create Team',
      editTitle: 'Edit Team',
      name: 'Team Name',
      namePlaceholder: 'e.g. Startup Core Team',
      description: 'Team Goal',
      descriptionPlaceholder: 'What this team owns and how it collaborates',
      noDescription: 'No team goal',
      coordinator: 'Team Coordinator',
      selectCoordinator: 'Select native HHAIOS employee',
      coordinatorHint: 'Required: coordinator must be a native react / plan_execute HHAIOS employee. ACP employees such as Hermes / Codex / OpenClaw can only be members.',
      nativeCoordinatorRequiredTitle: 'Native HHAIOS coordinator required',
      nativeCoordinatorRequiredDesc: 'A team needs a local employee that can call delegateToAgent / delegateParallel. ACP employees may join as members but cannot coordinate the team.',
      members: 'Members',
      membersHint: 'Add ACP specialists such as Hermes, Codex, and OpenClaw. The coordinator is included automatically.',
      selectedMembers: '{count} selected',
      membersCount: '{count} members',
      empty: 'No teams yet. Click Create Team, pick a native coordinator, then add ACP specialist members.',
      chatWithCoordinator: 'Open Team Chat',
      loadFailed: 'Failed to load teams',
      saveSuccess: 'Team saved; coordinator identity card now includes team orchestration rules',
      saveFailed: 'Failed to save team',
      deleteTitle: 'Delete Team',
      deleteConfirm: 'Delete team "{name}"? Employees will not be deleted.',
      deleteSuccess: 'Team deleted',
      deleteFailed: 'Failed to delete team',
      coordinatorRequired: 'Please select a team coordinator',
      coordinatorMustBeNative: 'The team coordinator must be a native HHAIOS employee, not an ACP employee.',
    },
    ...
    fields: {
      ...
      icon: 'Icon',
      type: 'Type',
      acpEndpoint: 'External Agent',
      acpEndpointHint: 'First version supports only Hermes, Codex, and OpenClaw. Enable the connection under Settings -> ACP first.',
      acpRuntimeNote: 'ACP employees run the external agent directly. Sessions close after 30 minutes idle; the next message restores context from history. The identity card is saved and injected as HHAIOS instructions on every turn; HHAIOS skills, tools, and knowledge bases are disabled in this version.',
      description: 'Description',
      ...
      backstory: 'Identity Card / Backstory',
      backstoryHint: 'Put the employee identity card here. It is invisible to users but active in every conversation; include full persona, experience, beliefs, and working principles.',
      advanced: 'Advanced',
    ...
    placeholders: {
      ...
      backstory: 'Paste the identity card, or write: Spent 10 years in data — believes in asking the right question before writing SQL...',
    ...
    wizard: {
      ...
      runtimeKicker: 'External Agent',
      runtimeTitle: 'Create an external-agent employee directly',
      runtimeDesc: 'When Hermes / Codex / OpenClaw is configured, skip AI generation and use it as the employee runtime.',
      tryLabel: 'Try:',
  ...
  security: {
    ...
    toolGuard: {
      ...
      exportFileName: 'hhaios-guard-rules-{date}.json',
  ...
  billing: {
    ...
    desc: 'Manage your wallet balance, recharge packages, orders, and wallet ledger.',
    mockNoticeTitle: 'Local mock payment only',
    mockNoticeDesc: 'This page does not open a real payment gateway or charge real money. “Complete mock payment” only marks the local order as paid and credits the wallet ledger.',
    availableBalance: 'Available Balance',
    walletSubtitle: 'Future usage-based billing can consume this balance; the current MVP only records recharges.',
    pendingOrders: 'Pending Orders',
    recentCredits: 'Recent Credits',
    packages: 'Recharge Packages',
    packagesDesc: 'Pick a package to create a pending order, then complete it with local mock payment.',
    noPackages: 'No recharge packages available',
    bonus: '+ {amount}',
    packageFallbackDesc: 'Local mock recharge package',
    creditTotal: 'Credited total',
    createOrder: 'Create Order',
    pendingOrdersDesc: 'The MVP uses local mock payment instead of a real gateway.',
    mockPay: 'Complete mock payment',
    orders: 'Orders',
    ordersDesc: 'Recent recharge order statuses.',
    noOrders: 'No orders yet',
    ledger: 'Wallet Ledger',
    ledgerDesc: 'Recent balance changes.',
    ...
    paySuccess: 'Mock payment completed and wallet credited',
    payFailed: 'Mock payment failed',
  ...
  points: {
    kicker: 'Loyalty Points',
    title: 'Points Center',
    desc: 'View C-end user points balance, total earned, total spent, and points ledger.',
    rulesTitle: 'Points are separate from wallet balance',
    rulesDesc: 'Points can power membership benefits, campaign rewards, redemption, or future quota systems. Billing wallet balance remains money-based.',
    availablePoints: 'Available Points',
    level: 'Member Level',
    levelNormal: 'Normal',
    totalEarned: 'Total Earned',
    totalSpent: 'Total Spent',
    adminTitle: 'Admin Points Adjustment',
    adminDesc: 'Manually add or deduct user points. Every adjustment is written to the immutable ledger.',
    targetUser: 'Target User',
    selectUser: 'Select user',
    adjustAmount: 'Points Delta',
    adjustAmountHint: 'Positive to add, negative to deduct',
    adjustReason: 'Reason',
    adjustRemark: 'Remark',
    submitAdjust: 'Submit',
    ledger: 'Points Ledger',
    ledgerDesc: 'Recent points balance changes.',
    noLedger: 'No points ledger entries yet',
    reason: 'Reason',
    amount: 'Delta',
    balanceAfter: 'Balance After',
    remark: 'Remark',
    createdAt: 'Created',
    loadFailed: 'Failed to load points info',
    loadUsersFailed: 'Failed to load users',
    adjustInvalid: 'Select a user and enter a non-zero integer delta',
  ...
  acp: {
    ...
    title: 'ACP Endpoints',
    desc: 'Delegate prompts to Hermes, Codex, and OpenClaw over ACP/stdout-stdio. Task calls use ACP; versions, install state, and health are probed through each CLI.',
    ...
    agents: {
      title: 'Managed agent status',
      loading: 'Checking agents...',
      empty: 'No agent diagnostics yet',
      loadFailed: 'Failed to load agent diagnostics',
      installed: 'Installed',
      acpReady: 'ACP ready',
      endpoint: 'Endpoint configured',
      nativeAcp: 'Native ACP',
      adapterAcp: 'ACP adapter',
      ready: 'Ready',
      configured: 'Enable next',
      needsSetup: 'Setup needed',
      useDetectedCommand: 'Use detected command',
      actions: {
        installCli: 'Install the CLI, or set the endpoint command to the full binary path.',
        useDetectedCommand: 'The detected absolute path can be applied to this endpoint.',
        fixAcp: 'Fix the ACP entry point before enabling this endpoint.',
        enableEndpoint: 'Enable the endpoint after the connection test passes.',
      },
    },
    env: {
      ...
      hints: {
        ...
        dashscope: 'Aliyun DashScope key — same value as HHAIOS .env DASHSCOPE_API_KEY',
  ...
  plugins: {
    ...
    emptyHint: 'Place plugin JAR files in the configured plugin directory and restart the server',
  ...
  triggers: {
    ...
    targetDifyWorkflow: 'Global Dify workflow',
    targetDifyWorkflowEmpty: 'Dify workflow is not configured yet.',
    targetDifyAdminOnly: 'Dify triggers use the global API key; only global admins can create, edit, toggle or delete them.',
    patternTypeLabels: {
      cron: 'Cron schedule',
  ...
  difyWorkflow: {
    ...
    desc: 'Configure one global Dify Workflow App, run it manually or from triggers, and keep complete run records in HHAIOS.',
    warningTitle: 'External send and persistence',
    warningBody: 'Runtime inputs are sent to {baseUrl}; complete Dify outputs, raw responses and errors are stored in HHAIOS run records.',
    configTitle: 'Global config',
    configDesc: 'M1 supports only Dify official cloud and one global API key. The API key is write-only and never echoed back.',
    runTitle: 'Test and manual run',
    runDesc: 'Calls Dify in blocking mode. The UI waits up to about 110 seconds; backend read timeout is 95 seconds.',
    runsTitle: 'Recent runs',
    runsDesc: 'Dify outputs are only saved here; they are not automatically delivered to chat or channels.',
    enabled: 'Enabled',
    disabled: 'Disabled',
    testing: 'Testing...',
    running: 'Running...',
    ...
    noRuns: 'No Dify run records yet.',
    selectRun: 'Select a run record to view details.',
    loadFailed: 'Failed to load Dify config',
    runsLoadFailed: 'Failed to load Dify runs',
    saveSuccess: 'Dify config saved',
    saveFailed: 'Failed to save Dify config',
    testSubmitted: 'Test run completed',
    runSubmitted: 'Manual run completed',
    runFailed: 'Dify run failed',
    invalidJson: '{label} is not valid JSON: {msg}',
    ...
    fields: {
      ...
      baseUrl: 'Base URL',
      apiKey: 'API Key',
      apiKeyPlaceholder: 'Paste Dify Workflow App API key',
      apiKeyConfigured: 'Configured; leave blank to keep it',
      apiKeyHint: 'Only written on save. The backend stores it encrypted; the UI never reads or displays the current key.',
      enabled: 'Enable Dify workflow',
      enabledHint: 'When disabled, manual runs and trigger runs are rejected by the backend.',
      inputSchemaJson: 'Input notes JSON',
      defaultInputsJson: 'Default inputs JSON',
      runInputsJson: 'Inputs JSON for this run',
    },
    detail: {
      triggeredBy: 'Source',
  ...
  login: {
    ...
    heroDesc: 'HHAIOS is not about stuffing more capability into a chat box. It is about pulling context, knowledge, execution, and memory into one reliable operating surface.',
