  ...
  },
  {
    ...
    items: filterNav([
      ...
      },
      {
        path: '/billing',
        label: t('nav.billing'),
        icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 1v22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/><circle cx="19" cy="17" r="3"/></svg>`,
      },
      {
        path: '/points',
        label: t('nav.points'),
