...
VALUES
  (100000900801, '体验包', '本地模拟充值：¥10 到账 ¥10', 1000, 0, 'CNY', TRUE, 10, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
  (100000900802, '标准包', '本地模拟充值：¥50 到账 ¥55', 5000, 500, 'CNY', TRUE, 20, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0),
  (100000900803, '专业包', '本地模拟充值：¥100 到账 ¥115', 10000, 1500, 'CNY', TRUE, 30, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)
